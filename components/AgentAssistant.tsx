  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'שלום! Welcome to KFAR Marketplace! I can help you find vegan products, suggest recipes, or answer questions about our vendors. How can I assist you today?',
      timestamp: new Date()
    }
  ]);
