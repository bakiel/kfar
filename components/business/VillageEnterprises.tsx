  ...
  const enterprises: Enterprise[] = [
    {
      ...
      featured: [
        {
          url: '/images/vendors/teva_deli_vegan_seitan_schnitzel_breaded_cutlet_plant_based_meat_alternative_israeli_comfort_food.jpg',
          caption: 'Classic Seitan Schnitzel'
        },
        {
          url: '/images/vendors/teva_deli_vegan_seitan_kubeh_middle_eastern_specialty_plant_based_meat_alternative_israeli_cuisine.jpg',
          caption: 'Traditional Kubeh'
        },
        {
          url: '/images/vendors/teva_deli_vegan_specialty_product_01_plant_based_meat_alternative_israeli_cuisine.jpg',
    ...
    },
    {
      ...
      featured: [
        {
          url: '/images/vendors/queens-cuisine/queens_cuisine_vegan_burger_seitan_patty_sesame_bun_tomato_lettuce_plant_based_sandwich.jpg',
          caption: 'Gourmet Vegan Burger'
        },
        {
          url: '/images/vendors/queens-cuisine/queens_cuisine_vegan_meatballs_pasta_dish_plant_based_italian_cuisine_tomato_sauce.jpg',
          caption: 'Italian-Style Meatballs'
        },
        {
          url: '/images/vendors/queens_cuisine_vegan_meat_grilled_seitan_steaks_plant_based_protein_alternative.jpg',
    ...
    },
    {
      ...
      featured: [
        {
          url: '/images/vendors/gahn_delight_ice_cream_passion_mango_double_scoop_cup.jpg',
          caption: 'Passion Mango Delight'
        },
        {
          url: '/images/vendors/gahn_delight_ice_cream_chocolate_tahini_swirl_cup_with_cacao_nibs.jpeg',
          caption: 'Chocolate Tahini Swirl'
        },
        {
          url: '/images/vendors/gahn_delight_ice_cream_pistachio_rose_triple_scoop_ceramic_bowl.jpeg',
