...
const StatsSection = () => {
  ...
  const primaryStats: Stat[] = [
    ...
    {
      number: '100%',
      label: 'Vegan Since 1973',
      sublabel: "World's First",
      icon: 'fa-leaf',
      color: '#c23c09',
  ...
  const businessHighlights = [
    { icon: 'fa-industry', value: '40+', label: 'Years Manufacturing', business: 'Teva Deli Since 1983' },
    { icon: 'fa-globe', value: '5', label: 'Export Countries', business: 'USA, Europe, Russia' },
    { icon: 'fa-briefcase', value: '50+', label: 'Employees', business: '80% Community Members' },
    { icon: 'fa-certificate', value: '100+', label: 'Life Expectancy', business: 'Healthy Living Model' }
  ];

  const milestones = [
    { year: '1967', event: 'Journey Begins', detail: 'Chicago → Liberia → Israel' },
    { year: '1969', event: 'Dimona Settlement', detail: '2.8 hectares in Negev Desert' },
    { year: '1973', event: '100% Vegan', detail: 'First worldwide community' },
    { year: '1983', event: 'Teva Deli Opens', detail: 'Pioneering vegan industry' }
  ];
