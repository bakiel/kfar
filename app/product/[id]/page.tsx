...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      // First, check if it's a numeric ID from the API
        ...
        try {
          ...
          if (response.ok) {
            ...
            const transformedProduct = {
              ...data,
              id: data.id.toString(),
              image: data.primary_image || (data.images && data.images[0]) || '/images/placeholder.jpg',
              images: data.images || [data.primary_image || '/images/placeholder.jpg'],
              ...
              longDescription: data.description_he || data.description_en || data.description,
              specifications: [],
              ...
              vegan: data.is_vegan || (data.dietary_info && data.dietary_info.includes('vegan')),
              kosher: data.is_kosher || (data.dietary_info && data.dietary_info.includes('kosher')),
              organic: data.is_organic || (data.dietary_info && data.dietary_info.includes('organic')),
              kashrut: data.is_kosher ? 'Kosher Certified' : null,
              glutenFree: data.dietary_info && data.dietary_info.includes('gluten-free')
            };
