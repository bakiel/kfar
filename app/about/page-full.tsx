            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { year: '2024', title: 'Digital Marketplace Launch', description: 'KFAR Marketplace launches, bringing community businesses and culture to the global digital marketplace.' }
                ].map((item, index) => (
                  <div 
                    key={index}
