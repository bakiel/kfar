      ...
      <div className="min-h-screen" style={{ backgroundColor: '#fef9ef' }}>
        ...
        >
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">Complete guidance for your KFAR Marketplace experience</p>
        ...
        <section className={`py-16 ${activeSection === 'faq' ? 'block' : 'hidden'}`}>
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">Find answers to common questions about KFAR Marketplace</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="border-b border-gray-200">
                ...
                <div className={`overflow-hidden transition-all duration-300 ${activeFAQ === 0 ? 'max-h-96' : 'max-h-0'}`}>
                  <div className="p-6 bg-gray-50">
                    <p className="text-gray-600 mb-4">QR codes are the primary payment method at KFAR Marketplace. Here's how to use them:</p>
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <div className="flex justify-between items-center">
                    <h4 className="text-lg font-semibold">What makes KFAR Marketplace special?</h4>
                ...
                <div className={`overflow-hidden transition-all duration-300 ${activeFAQ === 1 ? 'max-h-96' : 'max-h-0'}`}>
                  <div className="p-6 bg-gray-50">
                    <p className="text-gray-600 mb-4">KFAR Marketplace is more than just an e-commerce platform:</p>
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <div className="flex justify-between items-center">
                    <h4 className="text-lg font-semibold">How do I become a vendor on KFAR Marketplace?</h4>
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <div className="flex justify-between items-center">
                    <h4 className="text-lg font-semibold">Can tourists and visitors use KFAR Marketplace?</h4>
                ...
                <div className={`overflow-hidden transition-all duration-300 ${activeFAQ === 3 ? 'max-h-[600px]' : 'max-h-0'}`}>
                  <div className="p-6 bg-gray-50">
                    <p className="text-gray-600 mb-4">Absolutely! KFAR Marketplace welcomes visitors and provides special support:</p>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
        ...
        <section className={`py-16 ${activeSection === 'privacy' ? 'block' : 'hidden'}`}>
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">Legal information and policies governing KFAR Marketplace</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8" style={{ borderLeft: '4px solid #478c0b' }}>
              ...
              <div className="space-y-6 text-gray-600">
                <div>
                  ...
                  <p className="mb-4">By using KFAR Marketplace, you agree to these terms and our community values:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <div>
                  ...
                  <p className="mb-4">KFAR Marketplace upholds the values of the Village of Peace community:</p>
                  <div className="grid md:grid-cols-2 gap-6">
                    <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-3 text-gray-600">
                    <div>
                      <strong>KFAR Marketplace</strong><br/>
                      Village of Peace<br/>
                      Dimona, Israel
                    </div>
                    <div>
