...
export const servicesData: ServiceCategory[] = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        status: 'active',
        icon: 'fa-gift',
        description: 'Village marketplace hub',
        longDescription: 'Central marketplace featuring local artisan products, community merchandise, and cultural items.',
        ...
        priceRange: '₪20-200',
        tags: ['marketplace', 'artisan', 'gifts', 'cultural', 'community'],
        featured: true,
        rating: 4.8,
        reviewCount: 267
      },
